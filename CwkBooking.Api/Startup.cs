...
namespace CwkBooking.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Will create an Instance the first time it required
            services.AddSingleton<DataSource>();
            services.AddSingleton<DataSourceService>();


            ////Will create an Instance each time it required
            //services.AddTransient<DataSource>();

            ////Will create an Instance for each request
            //services.AddScoped<DataSource>();


            services.AddSingleton<ISingletonOperation, SingletonOperationService>();
            services.AddTransient<ITransientOperation, TransientOperationService>();
            services.AddScoped<IScopedOperation, ScopedOperationService>();
